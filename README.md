...
## 总结
当前项目依旧拥有很多改善空间，如果对raft感兴趣，可以查看tikv，etcd-raft等等优秀实现，阅读并学习这些优秀项目对于理解raft更加有帮助。
另外，本项目的raft采取的是传递绝对日志索引，而链接 "https://gitee.com/YuXinAndYang/6.824.git" 采取相对索引（更加复杂，更难管理，实际是未考虑uint64大小而做的多余设计）
所以, 本项目重构了部分代码，并修改了原仓库的部分错误，继续完成了课程大部分内容。
